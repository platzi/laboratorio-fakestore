    ...
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            api = "".concat(API, "?offset=").concat(localStorage.offset, "&limit=").concat(localStorage.limit);
            _context.prev = 1;
            _context.next = 4;
            return fetch(api);
          case 4:
...
/* harmony default export */ const LazyLoader = (lazyLoader);
;// CONCATENATED MODULE: ./src/templates/Template.js
...
function _renderProducts() {
  _renderProducts = _asyncToGenerator( /*#__PURE__*/regenerator_default().mark(function _callee() {
    var data, allItem;
    return regenerator_default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            data.forEach(function (product) {
              ...
              var cardPrice = document.createElement('small');
              cardImage.dataset.src = product.images[0];
              cardImage.alt = product.title;
              cardTitle.innerText = "".concat(product.id, " ").concat(product.title);
            ...
            sectionCard.append.apply(sectionCard, allItem);
          case 6:
          case "end":
            return _context.stop();
        }
...
/* harmony default export */ const Template = (renderProducts);
;// CONCATENATED MODULE: ./src/utils/infiniteScroll.js

var endOfCatalog = document.querySelector('.catalog-finish');
...
/* harmony default export */ const utils_infiniteScroll = (infiniteScroll);
...
window.addEventListener('scroll', utils_infiniteScroll, {
  passive: false
});
})();
